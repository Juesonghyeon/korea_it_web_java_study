...
public class Main {
    public static void main(String[] args) {
        ...
        KoreaItStudent koreaItStudent = new KoreaItStudent("샌즈", 200);
        System.out.println(koreaItStudent.getName());
        ...
        //공유 - 모든 인스턴스가 동일한 static 변수에 접근, 따라서 데이터를 공유하거나 상태를 저장할때 유용
    }
}
