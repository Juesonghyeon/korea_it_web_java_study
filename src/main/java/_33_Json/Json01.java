package _33_Json;
//Json(Javascript Object Notation_
//본래 자바스크립트 언어로부터 파생되어 자바스크립트 구문을 따르지만, 언어 독립형 데이터
//Map 형태처럼 키 값 형태
...
//Gson
//Google Json의 약자로 Java 객체를 Json형태로 변환하거나 혹은 반대로 변환하는대 사용
//주요 클래스
...
public class Json01 {
    public static void main(String[] args) {
        ...
        //속석(key - value)을 추가하는 메소드 => addProperty()
        jsonObject1.addProperty("username", "songhyeon");
        jsonObject1.addProperty("password", 1234);
        jsonObject1.addProperty("email", "test@gmail.com");
        jsonObject1.addProperty("name", "주송현");
        ...
        System.out.println(jeson1);

        JsonObject address = new JsonObject();
        address.addProperty("city", "부산시");
        address.addProperty("district", "북구");
